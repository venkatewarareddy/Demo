...
import com.adobe.aem.guides.demo.core.helper.NastedHalper;
...
public class AuthorBooksModel implements AuthorBooks {
    private static final Logger LOG = LoggerFactory.getLogger(AuthorBooksModel.class);
